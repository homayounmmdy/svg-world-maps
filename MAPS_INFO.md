...
- **Command**: The identifier used to reference or run this map (derived from the file name without the `.ts`
  extension).
- **Country Name**: The human-readable name of the map.
- **Code**: The standard short code assigned to the map.
- **States**: The total number of state/region objects defined in the map.
