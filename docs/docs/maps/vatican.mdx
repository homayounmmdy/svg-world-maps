---
title: Vatican Map
description: Interactive SVG map of Vatican with all subdivisions. Features tooltips, click handling, and hover colors inspired by the national flag.
sidebar_position: 80
sidebar_label: Vatican
---

import VaticanMap from '../../components/maps/va';
import Admonition from '@theme/Admonition';

# 🇻🇦 Vatican Interactive Map
...
* **Hover State:** We utilize a vibrant translucent color (`rgba(254, 218, 0, 0.35)`) to represent the national identity and heritage.
