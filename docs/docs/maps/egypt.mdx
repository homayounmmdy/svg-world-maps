---
title: Egypt Map
description: Interactive SVG map of Egypt with all subdivisions. Features tooltips, click handling, and hover colors inspired by the national flag.
sidebar_position: 25
sidebar_label: Egypt
---

import EgyptMap from '../../components/maps/eg';
