---
title: Slovenia Map
description: Interactive SVG map of Slovenia with all subdivisions. Features tooltips, click handling, and hover colors inspired by the national flag.
sidebar_position: 34
sidebar_label: Slovenia
---

import SloveniaMap from '../../components/maps/si';
...
The visual identity of this map pack is inspired by the **National Flag of Slovenia**.
* **Hover State:** We utilize a vibrant translucent color (`rgba(0, 51, 135, 0.35)`) to represent the national identity and heritage.
