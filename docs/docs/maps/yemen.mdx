---
title: Yemen Map
description: Interactive SVG map of Yemen with all subdivisions. Features tooltips, click handling, and hover colors inspired by the national flag.
sidebar_position: 58
sidebar_label: Yemen
---

import YemenMap from '../../components/maps/ye';
import Admonition from '@theme/Admonition';

# 🇾🇪 Yemen Interactive Map
