---
title: China Map
description: Interactive SVG map of China with all subdivisions. Features tooltips, click handling, and hover colors inspired by the national flag.
sidebar_position: 20
sidebar_label: China
---

import ChinaMap from '../../components/maps/cn';
