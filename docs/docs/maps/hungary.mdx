---
title: Hungary Map
description: Interactive SVG map of Hungary with all subdivisions. Features tooltips, click handling, and hover colors inspired by the national flag.
sidebar_position: 47
sidebar_label: Hungary
---

import HungaryMap from '../../components/maps/hu';
